  ...
  return (
    <aside className="flex h-full w-[252px] flex-shrink-0 flex-col border-r border-slate-200/80 bg-white">
      <div className="flex h-[72px] items-center gap-3 border-b border-slate-100 px-5">
        <div className="grid h-10 w-10 flex-shrink-0 place-items-center rounded-[14px] bg-gradient-to-br from-indigo-600 to-violet-600 shadow-[0_8px_20px_rgba(79,70,229,0.2)]">
      ...
      <div className="border-t border-slate-100 p-3">
        <button
          ...
          className={`mb-2 flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-[12px] font-medium transition-colors ${
            activeTab === 'settings' ? 'bg-indigo-50 text-indigo-700' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-800'
          }`}
        >
        ...
        <div className="flex items-center gap-3 rounded-2xl bg-slate-50 px-3 py-3 ring-1 ring-slate-100">
          {currentUser.avatar ? (
            ...
            <div className="grid h-9 w-9 place-items-center rounded-xl bg-indigo-100 text-xs font-bold text-indigo-700">
