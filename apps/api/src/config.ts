...
const envSchema = z
  .object({
    ...
    API_RATE_LIMIT_ENABLED: booleanFromEnv.default('true'),
    API_RATE_LIMIT_MAX_REQUESTS: z.coerce.number().int().min(10).max(10000).default(300),
    API_RATE_LIMIT_WINDOW_SECONDS: z.coerce.number().int().min(1).max(3600).default(60),
    API_RATE_LIMIT_MAX_KEYS: z.coerce.number().int().min(100).max(100000).default(20000),
